...
All notable project-level changes should be recorded here. FinTerminal follows a pragmatic pre-1.0 release process; interfaces may still change as the project matures.
...
Initial public development baseline for the FinTerminal MCP research service and desktop application.

> Earlier development history is preserved in Git commits. This changelog starts as a curated project-level summary rather than a retroactive transcription of every commit.
